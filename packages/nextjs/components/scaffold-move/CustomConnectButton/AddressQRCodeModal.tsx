...
export const AddressQRCodeModal = ({ address, modalId, setShow }: AddressQRCodeModalProps) => {
  ...
  return (
    <div className="">
      {/* Blurry backdrop */}
      <div
        className="fixed inset-0 bg-gray-500 bg-opacity-50 text-background backdrop-blur-sm z-40 cursor-pointer"
        onClick={closeModal}
      ></div>
      {/* Modal content */}
      <div
      ...
      >
        ...
        >
          <button
            className="btn btn-ghost btn-sm btn-circle !text-background absolute right-3 top-3"
            onClick={closeModal}
          >
            ✕
          </button>
          <div className="space-y-6 py-6 flex flex-col items-center">
            ...
            <div className="break-all !text-background text-center">
